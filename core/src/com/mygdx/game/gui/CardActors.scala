...
object SlotCardActors {
  ...
  def createActors(slotState : SlotState, game : SpGame, resources : ScreenResources) = {
    val group = new Group
  ...
  def createEntity(slotnum : Int, playerId : PlayerId, slotState : SlotState, game : SpGame, resources : ScreenResources, source : Vector2) = {
...
class SlotCardActors(val cardGroup : Group, card : Creature, cardActors : CardActors, game : SpGame) {
