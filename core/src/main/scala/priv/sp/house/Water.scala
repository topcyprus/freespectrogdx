...
trait Water {
  ...
  val Water = House("water", List(
    ...
    new Creature("Merfolk Elder", Attack(3), 16, "Increase air mana growth by 1", reaction = ManaGrowthReaction(1, 2)),
    ...
    new Creature("Mind Master", Attack(6), 22, "Increase mana growth by 1", reaction = ManaGrowthReaction(1, 0, 1, 2, 3, 4)),
    new Creature("Astral guard", Attack(1), 17, "Decrease mana growth by 1", reaction = OppManaGrowthReaction(-1, 0, 1, 2, 3, 4))),
  houseIndex = 1)
